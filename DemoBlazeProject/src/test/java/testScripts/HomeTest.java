...
public class HomeTest extends Baseclass {
	...
	ExtentTest test = report.startTest("Home Page Links Test");
...
//	org.openqa.selenium.ElementClickInterceptedException: element click intercepted: Element <span class="vjs-control-text" aria-live="polite">...</span> is not clickable at point
//		xpath: //span[.='Play Video']]
		...
		wait.until(ExpectedConditions.elementToBeClickable(homePage.getPlayButton()));
